...
module.exports = function(app, passport) {
	...
	// =====================================
	// show the login form
	app.get(subroute + '/login', function(req, res) {
	...
	app.post('/login', passport.authenticate('local-login', {
            successRedirect : subroute + '/profile', // redirect to the secure profile section
	...
	app.get(subroute + '/signup', function(req, res) {
		// render the page and pass in any flash data if it exists
